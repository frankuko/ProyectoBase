...
/**
 * Created by javier on 12/03/2016.
 */
public class OpenCVARViewer extends SurfaceView implements SurfaceHolder.Callback,Runnable {
    ...
    public OpenCVARViewer(Context context) {
        super(context);
    ...
    public void surfaceCreated(final SurfaceHolder holder) {
        ...
        mCamera.setPreviewCallback(new PreviewCallback() {
            public void onPreviewFrame(byte[] data, Camera camera) {
                synchronized (OpenCVARViewer.this) {
                    mFrame = data;
                    OpenCVARViewer.this.notify();
                }
            }
        });
